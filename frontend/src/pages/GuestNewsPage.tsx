...
export default function GuestNewsPage() {
  ...
  const {
    ...
    queryKey: ['news', selectedCategory, selectedSourceType, selectedCompanies, searchQuery, currentPage],
    queryFn: () => {
  ...
  useEffect(() => {
    setCurrentPage(0)
  }, [selectedCategory, selectedSourceType, selectedCompanies, searchQuery])
      ...
      <div className="mb-8">
        <div className="flex justify-between items-start">
          ...
          <div className="bg-blue-50 rounded-lg p-4 text-center min-w-[200px]">
            <div className="text-sm text-blue-600 mb-2">Want more features?</div>
            <Link 
              to="/login" 
